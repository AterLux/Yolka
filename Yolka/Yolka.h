...
#define IMMED_COUNTDONW_INIT 25 // Количество кадров (т.е. периодов 1/50 секунды) после вывод данных от клиента, в течение которых данные с тем же приоритетом от других подключившихся будут игнорироваться
